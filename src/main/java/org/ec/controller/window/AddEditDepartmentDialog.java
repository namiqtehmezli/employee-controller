...
public class AddEditDepartmentDialog extends Window{
	...
	private Binder<Department> binder = new Binder<>();
	
	private ButtonClickCallback<Department> clickCallback;
	
	public AddEditDepartmentDialog setClickCallback(ButtonClickCallback<Department> clickCallback) {
		this.clickCallback = clickCallback;
		return this;
	}
	
	public AddEditDepartmentDialog() {
		// TODO Auto-generated constructor stub
	}
	
	public AddEditDepartmentDialog(Department department) {

		setCaption("Edit Department");
	...
	private HorizontalLayout addFooter(){
		...
		btnSave.addClickListener(event -> {
			binder.validate();
			if(binder.isValid()){
				clickCallback.clicked(department);
				close();
			}
		});
